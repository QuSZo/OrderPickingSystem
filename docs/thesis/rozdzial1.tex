...
coś napisać o planszy, że są przecinające się linie które odpowiadają współrzędnym kartezjańskim opisującym pozycję produktów ale również skrzyżowania (?) czyli miejsca w których robot może zmienić kierunek jazdy. Coś tam o grafie nieskierowanym. Może przedstawić taki graf wygenerowany w pythonie. Szczerze zrobiłbym z tego rozdział.
