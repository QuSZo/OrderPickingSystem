...
namespace Api.TravelingSalesmanAlgorithms.DijkstraGreedyAlgorithms; 

public class DijkstraGreedyAlgorithm : ITravelingSalesmanAlgorithm
{
    private readonly ILogger _logger;

    public DijkstraGreedyAlgorithm(ILoggerFactory loggerFactory)
    {
    ...
    public TspAlgorithmResult FindPath(List<Position> positions)
    {
        ...
        using (Py.GIL())
        {
            ...
            dynamic script = Py.Import("TravelingSalesmanAlgorithms.DijkstraGreedyAlgorithms.DijkstraGreedyAlgorithmScript");
