...
namespace Api.TravelingSalesmanAlgorithms.BruteForceAlgorithms; 
...
public class BruteForceAlgorithm : ITravelingSalesmanAlgorithm
{
    ...
    public TspAlgorithmResult FindPath(List<Position> positions)
    {
        ...
        using (Py.GIL())
        {
            ...
            dynamic script = Py.Import("TravelingSalesmanAlgorithms.BruteForceAlgorithms.BruteForceAlgorithmScript");
