...
namespace Api.TravelingSalesmanAlgorithms.AStarGreedyAlgorithms; 

public class AStarGreedyAlgorithm : ITravelingSalesmanAlgorithm
{
    private readonly ILogger _logger;

    public AStarGreedyAlgorithm(ILoggerFactory loggerFactory)
    {
    ...
    public TspAlgorithmResult FindPath(List<Position> positions)
    {
        ...
        using (Py.GIL())
        {
            ...
            dynamic script = Py.Import("TravelingSalesmanAlgorithms.AStarGreedyAlgorithms.AStarGreedyAlgorithmScript");
